...
var yarnWorkspaceRoot = require('@node-kit/yarn-workspace-root');
...
function _yarnWorkspaceInfo() {
  _yarnWorkspaceInfo = _asyncToGenerator(function* () {
    ...
    var root = yield yarnWorkspaceRoot.yarnWorkspaceRoot(cwd);
    if (!root) {
...
function yarnWorkspaceInfoSync() {
  var cwd = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : process.cwd();
  var root = yarnWorkspaceRoot.yarnWorkspaceRootSync(cwd);
  if (!root) {
    console.error("not a yarn workspace project");
    return null;
  }
...
exports.yarnWorkspaceInfo = yarnWorkspaceInfo;
exports.yarnWorkspaceInfoSync = yarnWorkspaceInfoSync;
