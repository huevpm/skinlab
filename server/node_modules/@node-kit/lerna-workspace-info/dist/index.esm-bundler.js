...
import { lernaWorkspaceRootSync, lernaWorkspaceRoot } from '@node-kit/lerna-workspace-root';
...
function _lernaWorkspaceInfo() {
  _lernaWorkspaceInfo = _asyncToGenerator(function* () {
    ...
    var root = yield lernaWorkspaceRoot(cwd);
    if (!root) {
...
function lernaWorkspaceInfoSync() {
  var cwd = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : process.cwd();
  var root = lernaWorkspaceRootSync(cwd);
  if (!root) {
    console.error("not a lerna workspace project");
    return null;
  }
...
export { lernaWorkspaceInfo, lernaWorkspaceInfoSync };
