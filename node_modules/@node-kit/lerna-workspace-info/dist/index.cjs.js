...
var extra_path = require('@node-kit/extra.path');
var lernaWorkspaceRoot = require('@node-kit/lerna-workspace-root');
...
function lernaWorkspaceInfo() {
  return _lernaWorkspaceInfo.apply(this, arguments);
}
function _lernaWorkspaceInfo() {
  _lernaWorkspaceInfo = _asyncToGenerator(function* () {
    var cwd = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : process.cwd();
    var root = yield lernaWorkspaceRoot.lernaWorkspaceRoot(cwd);
    if (!root) {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
        ...
        workspaceInfo[extra_path.dirname(projectPath)] = {
          path: projectPath
        };
      }
    } catch (err) {
...
function lernaWorkspaceInfoSync() {
  var cwd = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : process.cwd();
  var root = lernaWorkspaceRoot.lernaWorkspaceRootSync(cwd);
  if (!root) {
    console.error("not a lerna workspace project");
    return null;
  }
...
exports.lernaWorkspaceInfo = lernaWorkspaceInfo;
exports.lernaWorkspaceInfoSync = lernaWorkspaceInfoSync;
