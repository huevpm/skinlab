...
var pnpmWorkspaceRoot = require('@node-kit/pnpm-workspace-root');
...
function _pnpmWorkspaceInfo() {
  _pnpmWorkspaceInfo = _asyncToGenerator(function* () {
    ...
    var root = yield pnpmWorkspaceRoot.pnpmWorkspaceRoot(cwd);
    if (!root) {
      console.error("not a pnpm workspace project");
      return null;
    }
    var manifest = yield loadYml.loadYml(path.join(root, WORKSPACE_MANIFEST_FILENAME));
...
function pnpmWorkspaceInfoSync() {
  var cwd = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : process.cwd();
  var root = pnpmWorkspaceRoot.pnpmWorkspaceRootSync(cwd);
  if (!root) {
    console.error("not a pnpm workspace project");
    return null;
  }
  var manifest = loadYml.loadYmlSync(path.join(root, WORKSPACE_MANIFEST_FILENAME));
...
exports.pnpmWorkspaceInfo = pnpmWorkspaceInfo;
exports.pnpmWorkspaceInfoSync = pnpmWorkspaceInfoSync;
