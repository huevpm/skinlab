...
exports.getCommitHash = exports.parseGitCommit = exports.parseCommits = exports.gitPush = exports.gitTag = exports.gitCommit = exports.gitAdd = exports.getGitDiff = exports.getLatestGitTagForPattern = void 0;
/**
...
async function gitCommit({ messages, additionalArgs, dryRun, verbose, logFn, }) {
    ...
    try {
        ...
        await (0, exec_command_1.execCommand)('git', ['diff-index', '--quiet', 'HEAD']);
    }
    catch {
        hasStagedFiles = true;
    }
